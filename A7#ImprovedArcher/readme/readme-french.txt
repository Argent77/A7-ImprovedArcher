...
Le kit Archer d'origine ne s'accorde pas très bien à la progression de niveaux. S'il apparaît très puissant 
au tout début du jeu, il devient plus tard beaucoup moins utile, comparativement aux autres profils de rôdeur.
Ce mod s'efforce de l'améliorer en donnant à l'Archer quelques caractéristiques supplémentaires pour rendre 
ce kit intéressant à jouer même comme des adversaires très puissants.
...
téléchargée dans votre répertoire de jeu, d'exécuter soit "setup-A7#ImprovedArcher.exe" (Windows), 
soit "setup-A7#ImprovedArcher" (Mac OS X), et de suivre les instructions. Il est fortement recommandé 
de commencer une nouvelle partie après avoir installé ce mod.


Composants
~~~~~~~~~~

Ce mod comporte deux composants :
1. Kit d'Archer amélioré (pour BG2:ToB, BGT, BG:EE, BG:SoD, BG2:EE et IWD:EE)
- Installe le kit d'Archer

2. Ajouter deux arcs puissants et des flèches et des carreaux +4 dans le jeu (pour BG2:ToB, BGT, BG2:EE et IWD:EE)
...
Chaque composant peut être installé indépendamment.
...
- +1 à la classe d'armure contre les projectiles par 6 niveaux d'expérience.
- Peut atteindre la grande maîtrise (cinq étoiles) des arcs longs, des arcs courts et des arbalètes.
- Gagne tous les 4 niveaux la possibilité de tirer un trait immobilisant une fois par jour, à partir du niveau 4. 
...
- Gagne tous les 4 niveaux la possibilité de tirer un trait explosif une fois par jour, à partir du niveau 8. 
  Cette capacité n'est pas cumulable avec toute autre capacité de tir.
- Gagne tous les 4 niveaux la possibilité de créer des munitions bénies une fois par jour, à partir du niveau 4.
...
CREÉER DES MUNITIONS BÉNIES : L'Archer crée une munition spirituelle (flèche ou carreau) bénie par sa divinité 
                              tutélaire, qu'il peut utiliser pendant 8 heures et dotée de plusieurs charges.
...
- L'Archer ne peut pas porter d'armure métallique.
- Il ne peut pas se spécialiser dans les armes de mêlée.
